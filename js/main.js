  ...
  if (window.KI_PRODUCTS && Array.isArray(window.KI_PRODUCTS) && window.KI_PRODUCTS.length > 0) {
    return window.KI_PRODUCTS.map(function(p, i) {
      ...
      return {
        ...
        title: p.title || '',
        desc: p.desc || '',
        price: (typeof p.price === 'string' && p.price.startsWith('P')) ? p.price : (p.price ? 'P' + Number(p.price).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',') : 'P0.00'),
        originalPrice: (typeof p.originalPrice === 'string' && p.originalPrice.startsWith('P')) ? p.originalPrice : (p.origPrice ? 'P' + Number(p.origPrice).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',') : null),
...
const DEFAULT_PRODUCTS = [
  ...
  {id:'oc002',category:'outdoor',title:'Portable Gas Braai Stove',desc:'Compact 2-burner portable gas braai stove with folding legs, windshield panels, and piezo ignition. Ideal for camping and outdoor cooking.',price:'P640.00',image:'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=400&q=80',images:['https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=600&q=80'],special:false,featured:false,originalPrice:'P800.00',sortOrder:1},
  ...
  {id:'hh002',category:'household',title:'Digital Air Fryer 5L',desc:'5-litre digital air fryer with 8 preset cooking modes, touch control panel, 200°C max temp, and 60-minute timer. Uses 80% less oil.',price:'P1,280.00',image:'https://images.unsplash.com/photo-1648146027039-6b6ec6feaeef?w=400&q=80',images:['https://images.unsplash.com/photo-1648146027039-6b6ec6feaeef?w=600&q=80'],special:false,featured:false,originalPrice:'P1,600.00',sortOrder:1},
  ...
  {id:'va002',category:'vehicle',title:'Dash Camera Full HD 1080P',desc:'Full HD 1080P dash camera with 170° wide angle, night vision, loop recording, G-sensor, and 3-inch display. Includes 32GB SD card.',price:'P750.00',image:'https://images.unsplash.com/photo-1558618047-3c7e33c8bfde?w=400&q=80',images:['https://images.unsplash.com/photo-1558618047-3c7e33c8bfde?w=600&q=80'],special:false,featured:false,originalPrice:'P950.00',sortOrder:1},
